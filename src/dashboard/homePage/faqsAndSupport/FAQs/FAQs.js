  ...
  return (
    <div className="FAQs">
      ...
      <div className="stillhave  ">
        ...
        <p>
          Can't find the answer you are looking for ? Please chat to our support
          team{" "}
        </p>
      ...
      <div className="middlepagePart flex justify-between gap-[2em] mb-[3em] ">
        <div className="left max-w-[50em] ">
          ...
          <p>
            Student Loan Initiative is a program established by the Federal
            Government of Nigeria to break the barrier in Higher Education
          </p>
        </div>
      ...
      <div className="footer bg-green flex justify-between p-10 bg-green-600 ">
        <div className="right text-white ">
          <FaCopyright color="white" /> 2024 Nigeria Student Loan. All Right
          Reserved.
        </div>
